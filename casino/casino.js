...
function Person() {
  ...
  this.update = function()
  {
    ...
    switch (this.thought)
    {
      ...
      case "findGameToPlay":
        ...
        {
          this.thought = "wandering";
          this.mood -= 2; //I'm upset because I couldn't find a game to play.
        }
      ...
      case "moveToGame":
        ...
        if (this.closeToGoal()) {
          ...
          if (this.gameImPlaying.currentPlayers >= this.gameImPlaying.maxPlayers) {
            this.gameImPlaying = 0;
            this.thought = "findGameToPlay";
            this.mood -= 2;  //I didn't make it in time and now I'm sad.
          }
          else
          {
  ...
  this.draw = function()
  {
    ...
    this.context.drawImage(personImage, 16 * this.frame, 0, 16, 16, this.x, this.y, 16, 16);
